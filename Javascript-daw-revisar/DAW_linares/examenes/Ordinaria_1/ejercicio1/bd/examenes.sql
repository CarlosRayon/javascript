CREATE USER IF NOT EXISTS  'ddwec_ord1'@'localhost' IDENTIFIED BY 'ddwec_ord1';

GRANT USAGE ON * . * TO 'ddwec_ord1'@'localhost' IDENTIFIED BY 'ddwec_ord1' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

CREATE DATABASE IF NOT EXISTS `ddwec_ord1` ;

GRANT ALL PRIVILEGES ON `ddwec_ord1` . * TO 'ddwec_ord1'@'localhost';
...
INSERT INTO `preguntas` (`id`, `examen`, `pregunta`) VALUES
(1, 'dwec', 'La estandarización de JavaScript es realizada por'),
(2, 'dwec', 'En JavaScript, para finalizar un bucle de tipo \"for\" se recomienda usar'),
(3, 'dwec', 'En JavaScript, ¿cómo se escribe una sentencia condicional para comprobar que la variable \"i\" es distinta de 5?'),
(4, 'dwec', 'En JavaScript, ¿cómo se escribe una sentencia condicional para comprobar que la variable \"i\" es igual a 5?'),
(5, 'dwec', '¿Dónde se puede insertar código JavaScript en un documento HTML?'),
(6, 'dwec', 'En JavaScript, el operador para concatenar cadenas es'),
(7, 'dwec', 'En JavaScript, ¿qué función se emplea para dividir una cadena en función de un separador?'),
(8, 'dwec', 'En JavaScript, respecto a la declaración de variables'),
(9, 'dwec', 'En JavaScript, ¿cuál es la forma correcta de crear un array?'),
(10, 'dwec', 'En JavaScript, ¿cómo se define una función llamada \"miFuncion\"?'),
(11, 'dwes', 'En PHP, para obtener el tamaño de un fichero se emplea la función'),
(12, 'dwes', 'En PHP, ¿qué función se emplea para convertir una cadena a minúsculas?'),
(13, 'dwes', 'En PHP, cuando se incluye un fichero con include o require'),
(14, 'dwes', 'En PHP, al subir un fichero, ¿qué propiedad de $_FILES almacena el tamaño del fichero subido?'),
(15, 'dwes', 'En PHP, ¿un objeto de una clase puede acceder a la parte privada de otro objeto de la misma clase?'),
(16, 'dwes', 'Un constructor es un tipo especial de'),
(17, 'dwes', 'En PHP, ¿cómo se obtiene la información de un formulario que ha sido enviado mediante el método \"get\"?'),
(18, 'dwes', 'En PHP, ¿qué función se emplea para realizar una redirección?'),
(19, 'dwes', 'En PHP, ¿cómo se genera un número aleatorio?'),
(20, 'dwes', 'Cuando un cliente web envía la información de un formulario al servidor'),
(21, 'diw', 'Indica cuál es el código CSS que define un borde de un elemento de 2 píxeles de ancho, de color negro y punteado'),
(22, 'diw', 'Indica cuál es el código CSS que define un texto en rojo, con el tipo de letra Arial y el tamaño 14 pixels'),
(23, 'diw', '¿Cuál es el lugar correcto en un documento HTML para hacer referencia a una hoja de estilo externa?'),
(24, 'diw', '¿Cómo se define un color de fondo para todas las etiquetas <h1> en CSS?'),
(25, 'diw', 'En CSS3, ¿con qué propiedad se define la transparencia de un elemento?'),
(26, 'diw', '¿Cómo se inserta un comentario en CSS?'),
(27, 'diw', 'En CSS, ¿qué pseudo clase se emplea para definir una propiedad cuando el cursor del ratón se sitúa sobre un elemento?'),
(28, 'diw', '¿Cómo se hace en CSS para que el símbolo de los elementos de una lista sea un cuadrado?'),
(29, 'diw', 'En CSS, ¿cómo se escribe un selector para que una regla se aplique a todos los párrafos que sean descendientes directos (hijos) de un elemento artículo (article)?'),
(30, 'diw', '¿Cómo se hace en CSS para que un enlace se muestre sin el subrayado?'),
(31, 'daw', 'El servidor de páginas web Apache es un claro ejemplo de una aplicación cliente-servidor, donde el equipo servidor contará con éste programa (Apache), mientras que los equipos clientes deben contar con:'),
(32, 'daw', 'HTTP es un protocolo “sin estado”, esto quiere decir que'),
(33, 'daw', ' El protocolo HTTP trabaja sobre el puerto 80, pero Apache2 dispone de la opción de utilizar las librerías SSL para aumentar la seguridad obteniendo el protocolo HTTPS, que trabaja en el puerto'),
(34, 'daw', 'Si queremos que nuestro servidor Apache2 reconozca los documentos con la extensión “.shtml” con más prioridad que los que poseen la extensión “.php” o “.html”, tendremos que modificar el archivo:'),
(35, 'daw', ' El \"Hosting virtual basado en direcciones IP\" consiste en identificar el dominio virtual a utilizar según'),
(36, 'daw', '6- El directorio en el que se alojarán los archivos de configuración correspondientes a los distintos dominios virtuales activos es'),
(37, 'daw', 'Que diferencia existe entre un certificado autofirmado y un certificado emitido por la FNMT (Fábrica Nacional de Moneda y Timbre).'),
(38, 'daw', 'El servidor Apache y el servidor de Microsoft (IIS) son los preferidos en los equipos existentes en la red, pero ¿Cual es el tercer servidor de páginas web más utilizado?'),
(39, 'daw', 'El alojamiento dedicado tiene...'),
(40, 'daw', 'Cuál de estos programas permite la gestión de la transferencia de ficheros con el alojamiento web');
