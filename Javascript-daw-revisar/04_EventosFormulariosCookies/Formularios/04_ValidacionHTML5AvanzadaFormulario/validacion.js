...
function validaNombre() {
    ...
    if (!elemento.checkValidity()) {//checkvalidity hace refenrecia a la validadcion que hace html
        if (elemento.validity.valueMissing) {//validity comprueba errores mediante varias propìedades...mirar w3c
...
function error(elemento) {
    document.getElementById("mensajeError").innerHTML = elemento.validationMessage;//Valido mensaje es el mensaje que  muestra el html en caso de error
